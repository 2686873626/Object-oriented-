...
public class Elevator extends Thread {
    ...
    public Elevator(Mission mission) {
    ...
    private void moveTo(int desFloor) {
        ...
        TimableOutput.println("ARRIVE-" + location);
    }
    
    private void Open() {
        if (!open) {
            TimableOutput.println("OPEN-" + location);
            open = true;
        }
    }
    ...
    private void Close() {
        if (open) {
            ...
            TimableOutput.println("CLOSE-" + location);
            open = false;
        }
    }
    
    private void passengerIn(PersonRequest passenger) {
        TimableOutput.println("IN-" + passenger.getPersonId() + "-" + location);
    }
    
    private void passengerOut(PersonRequest passenger) {
        TimableOutput.println("OUT-" + passenger.getPersonId() + "-" + location);
    }
}
